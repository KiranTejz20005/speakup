...
export const practiceSessions = mysqlTable("practiceSessions", {
  ...
  preparationSeconds: int("preparationSeconds").notNull().default(30),
  ...
  recordingKind: mysqlEnum("recordingKind", ["audio", "video"]).notNull().default("audio"),
  recordingMimeType: varchar("recordingMimeType", { length: 128 }),
